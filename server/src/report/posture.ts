...
/**
 * Transparent, explainable posture score (0–100) → letter grade — the same
 * model the dashboard surfaces (`web/src/lib/posture.ts`), kept in lockstep here
 * so a generated assessment grades an estate identically to the live dashboard.
 * It blends compliance coverage and remediation progress, penalized by
